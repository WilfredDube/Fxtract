...
class User extends Password {
	...
	protected static $db_fields = array('memberID', 'username', 'password', 'firstname', 'lastname', 'email', 'isadmin');
...
// ODO: add isAdmin method
  ...
  public static function find_user_by_sql($sql="", $params = []) {
	...
	public function create() {
		...
		$query = 'INSERT INTO members (firstname,lastname,username,password,email,active) VALUES (:firstname, :lastname, :username, :password, :email, :active)';
		$params = array(
	...
	private function get_user_hash($username){
		try {
			$query = 'SELECT password, username, memberID, isadmin FROM members WHERE username = :username AND active="Yes" ';
